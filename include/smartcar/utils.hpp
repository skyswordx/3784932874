...
enum class TrackState
{
    ...
    /**
     * 充电区需求：
     * 1. 车辆在该区域需要驶入其中一个停车位，停车位是在路旁由黑色胶带围成的平行四边形
     * 2. 停车片刻进行充电
     * 3. 之后再启动，倒车
     * 4. 注意：充电区的停车位是有多个的，车辆需要在其中一个停车位内进行充电
    ...
    /**
     * 临时停车区需求：
     * 1. 路旁立牌同侧有线宽2.5cm的黑色胶带虚线围成的矩形临时停车区域
     * 2. 可能需要微调驶入该区域
     * 3. 之后再启动，恢复直行
     */
